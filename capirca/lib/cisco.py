...
class PortToProtMap(object):
  PORTS_TCP = {
      5190: 'aol',             179: 'bgp',               19: 'chargen',
      1494: 'citrix-ica',      514: 'cmd',             2748: 'ctiqbe',
        13: 'daytime',           9: 'discard',           53: 'domain',
         7: 'echo',            512: 'exec',              79: 'finger',
        21: 'ftp',              20: 'ftp-data',          70: 'gopher',
       443: 'https',          1720: 'h323',             101: 'hostname',
       113: 'ident',           143: 'imap4',            194: 'irc',
       750: 'kerberos',        543: 'klogin',           544: 'kshell',
       389: 'ldap',            636: 'ldaps',            515: 'lpd',
       513: 'login',          1352: 'lotusnotes',       139: 'netbios-ssn',
      2049: 'nfs',             119: 'nntp',            5631: 'pcanywhere-data',
       496: 'pim-auto-rp',     109: 'pop2',             110: 'pop3',
      1723: 'pptp',             25: 'smtp',            1521: 'sqlnet',
        22: 'ssh',             111: 'sunrpc',            49: 'tacacs',
       517: 'talk',             23: 'telnet',           540: 'uucp',
        43: 'whois',            80: 'www'
  }
  PORTS_UDP = {
       512: 'biff',                68: 'bootpc',              67: 'bootps',
         9: 'discard',             53: 'domain',             195: 'dnsix',
         7: 'echo',               500: 'isakmp',             750: 'kerberos',
       434: 'mobile-ip',           42: 'nameserver',         137: 'netbios-ns',
       138: 'netbios-dgm',       2049: 'nfs',                123: 'ntp',
      5632: 'pcanywhere-status',  496: 'pim-auto-rp',       1645: 'radius',
      1646: 'radius-acct',        520: 'rip',               5510: 'secureid-udp',
       161: 'snmp',               162: 'snmptrap',           111: 'sunrpc',
       514: 'syslog',              49: 'tacacs',             517: 'talk',
        69: 'tftp',                37: 'time',               513: 'who',
       177: 'xdmcp',
  }
  TYPES_ICMP = {
      6: 'alternate-address',
...
class Term(aclgenerator.Term):
  ...
  def _FormatPort(self, port, proto):
    ...
    if self.platform == 'arista':
      port0 = self._TermPortToProtocol(port0, proto,
                PortToProtMap.ARISTA_PORTS_TCP,
                PortToProtMap.ARISTA_PORTS_UDP)
  ...
  def _TermPortToProtocol(self, port_num, proto,
                          ports_tcp=PortToProtMap.PORTS_TCP,
                          ports_udp=PortToProtMap.PORTS_UDP,
                          types_icmp=PortToProtMap.TYPES_ICMP):
