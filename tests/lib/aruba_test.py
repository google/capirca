...
class ArubaTest(unittest.TestCase):
  ...
  def testMultipleCallsSingleNetdestinationsBlock(self):
    expected_result = textwrap.dedent("""\
        ...
        ! $Date:$
        ! $Revision:$
        no netdestination gt-one-netd_src
  ...
  def testSingleNetdestinationIPv6(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination6 gt-one-netd_src
  ...
  def testTwoNetdestinationsIPv4(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination gt-two-netd_src
    netdestination gt-two-netd_src
      host 10.1.1.1
    !

    no netdestination gt-two-netd_dst
  ...
  def testTwoNetdestinationsIPv6(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination6 gt-two-netd_src
    netdestination6 gt-two-netd_src
      host 2001::
    !

    no netdestination6 gt-two-netd_dst
  ...
  def testTwoNetworkNetdestinationsIPv4(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination gt-mix-netd_src
    netdestination gt-mix-netd_src
      network 10.0.0.0 255.0.0.0
    !

    no netdestination gt-mix-netd_dst
  ...
  def testTwoNetworkNetdestinationsIPv6(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination6 gt-mix-netd_src
    netdestination6 gt-mix-netd_src
      network 2001:: ffff:ffff:ffff:ffff::
    !

    no netdestination6 gt-mix-netd_dst
  ...
  def testCombinedNetdestinationsIPv4(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination good-term-combined-netdestinations_src
  ...
  def testCombinedNetdestinationsIPv6(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination6 good-term-combined-netdestinations_src
    netdestination6 good-term-combined-netdestinations_src
      host 2001::
      network 2002:: ffff:ffff:ffff:ffff::
    !
  ...
  def testMultipleTermsIPv4(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination good-terms-combined-1_src
    netdestination good-terms-combined-1_src
      host 10.0.0.1
      network 100.0.0.0 255.0.0.0
    !

    no netdestination good-terms-combined-1_dst
  ...
  def testMultipleTermsIPv6(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination6 good-terms-combined-1_src
    netdestination6 good-terms-combined-1_src
      host 2001::
      network 2002:: ffff:ffff:ffff:ffff::
    !

    no netdestination6 good-terms-combined-1_dst
  ...
  def testSourceIsUser(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination good-term-source-is-user_dst
  ...
  def testDestinationIsUser(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination good-term-destination-is-user_src
  ...
  def testNegateWithNetwork(self):
    ...
    ! $Date:$
    ! $Revision:$
    no netdestination good-term-negate_src
